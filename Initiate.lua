...
local function getasset(path)
	if not isfile(path) then
		local req = requestfunc({
			Url = "https://raw.githubusercontent.com/githubuser2243/Future/main/"..path:gsub("Future/assets", "assets"),
			Method = "GET"
		})
...
local ontp = game:GetService("Players").LocalPlayer.OnTeleport:Connect(function(State)
    if State == Enum.TeleportState.Started then
        ...
        if isfile("Future/Initiate.lua") then 
            ...
            loadstring(game:HttpGet("https://raw.githubusercontent.com/githubuser2243/Future/main/Initiate.lua", true))() 
        end
        ]]
